...
// This refers to the instance of that object. In this case the Student object with the properties of .name = 'Joe';
// 2. What is "this" when joe.scopeArrow() is invoked?
// "This" refers to the instance of Window.
// 3. Explain why "this" is different when an arrow function is used.
// Different scoping methods. Arrow functions use lexical scope, which to my understanding, means they are looking at the wider scope of the environment. It's easiest to think about this inside of objects. If a traditional function is called inside of an object and it references an object property with 'this' the funtion won't be able to find the property because that property is located in the larger scope of the instance of the object, it isn't present in the function (which is just another property), so it will return undefined. However arrow functions look at the wider lexical scope, essentially using the scope of their parent. Using an arrow function within an object will allow that function to identify 'this' as the object it is a part of, rather than something within itself.